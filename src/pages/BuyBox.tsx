...
//       price_min: buyBox.price_min?.toString() || "",
...
//                       {filterByPpsf ? "Min Price per Square Foot" : "Min Total Price (for scraper)"}
//                     </Label>
//                     <Input
//                       id="price_min"
//                       name="price_min"
...
//                       onChange={handleChange}
//                       placeholder={filterByPpsf ? "0" : "0"}
//                     />
//                     <p className="text-xs text-muted-foreground">
//                       {filterByPpsf 
//                         ? "Minimum price per sqft to filter properties (e.g., $50/sqft)" 
//                         : "Minimum price to use when scraping properties from Zillow"}
//                     </p>
//                   </div>
//                   <div className="space-y-2">
